...
<head>
    ...
    <title>ABC Evening Institute</title>
</head>
<body>
    ...
    <div class="bg-indigo-900 relative overflow-hidden">
            ...
            <nav class="container mx-auto px-6 md:px-12 py-4" x-data="{ open: false }">
                <div class="md:flex justify-between items-center">
                    ...
                    <div class="hidden md:flex items-center">
                        ...
                        <a href="{{ route('login') }}" class="text-sm uppercase mx-3 text-white cursor-pointer hover:text-indigo-600"> Register/Login</a>
        ...
        <div class="container mx-auto px-6 md:px-12 relative z-10 flex items-center py-24 xl:py-40">
            <div class="lg:w-3/5 xl:w-2/5 flex flex-col items-start relative z-10">
                <span class="font-mitr uppercase text-indigo-500">ABC Evening Institute</span>
    
                <h1 class="font-roboto-slab text-4xl sm:text-6xl text-red-400 leading-tight mt-4">Let's go <br> back to
                    school</h1>
    
                <div class="max-w-md">
                    <p class="font-source-sans-pro text-indigo-500 mt-6 text-lg">Lorem ipsum dolor sit amet consectetur
