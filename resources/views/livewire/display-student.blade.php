    ...
    <div class="fixed z-10 inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            ...
            <form wire:submit.prevent="studentUpdate()" class="flex flex-col bg-white  p-12">
                ...
                <label class="font-semibold text-xs" for="email">Email Address</label>
                <input disabled wire:model="email"
                    class="flex items-center h-12 px-4 w-64 bg-gray-200 mt-2 rounded focus:outline-none focus:ring-2"
                    type="text">
    ...
    <div class="fixed z-10 inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            ...
            <form wire:submit.prevent="teacherAdd()" class="flex flex-col bg-white  p-12 mt-12">
                ...
                <select wire:model="teacherId" name="teacherId" id="teacherId"
                    class="flex items-center h-12 px-4 w-64 bg-gray-200 mt-2 rounded focus:outline-none focus:ring-2">
                ...
                <button
                    class="flex items-center justify-center h-12 px-6 w-64 bg-blue-600 mt-8 rounded font-semibold text-sm text-blue-100 hover:bg-blue-700">Assign</button>
            </form>
            <!-- Component End  -->
                ...
                <div class="rounded-t mb-0 px-4 py-3 border-0">
                    <div class="flex flex-wrap items-center">
                        ...
                        <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                            <button wire:click="$set('addStudent', true)"
                                class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                type="button">Add A Student</button>
                        </div>
                    ...
                    <table class="items-center bg-transparent w-full border-collapse ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td
                                    class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 ">
                                    <button wire:click="studentEdit({{ $student->id }})"
                                    ...
                                    <button wire:click="studentDelete({{ $student->id }})"
                                    ...
                                    <button wire:click="addTeacher({{ $student->id }})"
                                        class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                        type="button">Add a Teacher</button>
                                </td>
                            </tr>
                            @endforeach
