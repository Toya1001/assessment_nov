        ...
        <div class="bg-white rounded-lg">
            <div class="inline-flex rounded-lg">
                <button wire:click="register()" type="submit"
                    class="text-center self-center py-2 px-4 rounded-lg cursor-pointer hover:bg-indigo-700 focus:bg-indigo-700">Register</button>


            </div>
            <div class="inline-flex rounded-lg">
                <button type="submit" wire:click="login()"
                    class="text-center self-center py-2 px-4 rounded-lg cursor-pointer hover:bg-indigo-700 focus:bg-indigo-700">Login</button>
